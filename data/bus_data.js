const busRoutes = {
    ...
    "902": {
        ...
        stations: [
            ...
            {name: "华为", oneWay: "down"},
            {name: "南风", oneWay: "down"},
            {name: "花城广场北", oneWay: "up"},
            {name: "XX公司", oneWay: "up"},
            {name: "雨城广场", oneWay: "up"},
            {name: "航运公司", oneWay: "up"},
            {name: "玖里江山北门"},
            {name: "航运公司", oneWay: "down"},
            {name: "华为公司", oneWay: "up"},
            {name: "坂田城大厦", oneWay: "up"},
            {name: "唯品会大厦", oneWay: "up"},
            {name: "雨城广场"},
            {name: "XX公司", oneWay: "down"},
            {name: "花城广场北", oneWay: "down"},
            {name: "东升大厦", oneWay: "up"},
            {name: "国美大厦", oneWay: "up"},
    ...
    "903": {
        ...
        circularDirection: "counterclockwise",
        stations: [
            {name: "花城广场", oneWay: "down"},
            {name: "会展中心", oneWay: "down"},
            {name: "来又来", oneWay: "down"},
            {name: "都湖国际", oneWay: "down"},
            {name: "松山湖南", oneWay: "down"},
            {name: "华为公司", oneWay: "down"},
            {name: "玖里江山西门", oneWay: "down"},
            {name: "玖里江山南门", oneWay: "down"},
            {name: "玖里江山东门", oneWay: "down"},
            {name: "雨城广场南", oneWay: "down"},
            {name: "游泳馆东", oneWay: "down"},
            {name: "体育中心", oneWay: "down"},
        ]
    },
    "904": {
        name: "904路",
