export const busRoutes = {
    ...
    "V101": {
        ...
        stations: [
            {name: "临东大学东门"},
            {name: "学苑路学园街", oneWay: "up"},
            {name: "临东大学南门", oneWay: "up"},
            {name: "临东大学北门", oneWay: "down"},
            {name: "临东大学西门", oneWay: "down"},
            {name: "平山隧道北", oneWay: "down"},
            {name: "平山隧道南"},
            {name: "魔仙乐园西"},
            {name: "平山客运站"},
            {name: "临东汽配城"},
    ...
    "V108": {
        ...
        stations: [
            ...
            {name: "振工街临新路", oneWay: "down"},
            {name: "铁西广场南", oneWay: "down"},
            {name: "兴工街建设大路", oneWay: "down"},
            {name: "云峰街临新路", oneWay: "down"},
            {name: "云峰街腾桥路", oneWay: "down"},
            {name: "应昌大厦西", oneWay: "down"},
            {name: "应昌街小北二路", oneWay: "down"},
            {name: "建设大路云峰街", oneWay: "down"},
            {name: "瀚都国际", oneWay: "down"},
            {name: "临东站西公交枢纽", oneWay: "down"},
        ]
    },
    "临站": {
